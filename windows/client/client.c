...
int main()
{
	...
	//Ê¹ÓÃSocketµÄ³ÌÐòÔÚÊ¹ÓÃSocketÖ®Ç°±ØÐëµ÷ÓÃWSAStartupº¯Êý¡£ÒÔºóÓ¦ÓÃ³ÌÐò¾Í¿ÉÒÔµ÷ÓÃËùÇëÇóµÄSocket¿âÖÐµÄÆäËüSocketº¯ÊýÁË¡£
	//Ó¦ÓÃ³ÌÐòÔÚÍê³É¶ÔÇëÇóµÄSocket¿âµÄÊ¹ÓÃºó£¬Òªµ÷ÓÃWSACleanupº¯ÊýÀ´½â³ýÓëSocket¿âµÄ°ó¶¨²¢ÇÒÊÍ·ÅSocket¿âËùÕ¼ÓÃµÄÏµÍ³×ÊÔ´¡
	...
	cmd_sock = socket(AF_INET,SOCK_STREAM,0);  //AF_INETÊÇ IPv4 ,AF_INET6 ÊÇ IPv6 µÄ;¶ø AF_UNIX ÔòÊÇ Unix ÏµÍ³±¾µØÍ¨ÐÅ
	memset(serIP,0,20);
